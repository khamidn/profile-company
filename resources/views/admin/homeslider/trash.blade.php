...
@section('title') Trash Home Slider @endsection
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<form
								method="POST"
								action="{{route('manage-home-slider.restore', $slider->id)}}"
								class="d-inline">
								@csrf
							...
							<div 
								...
								<div 
								    ...
								    <div class="modal-content">
								   	...
								   	<form method="POST" action="{{route('manage-home-slider.delete-permanent', $slider->id)}}">
								   		@csrf
