...
@section('title') Trash Projects @endsection
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<form
								method="POST"
								action="{{route('manage-projects.restore', $project->id)}}"
								class="d-inline">
							...
							<div
								...
								<div
									...
									<div class="modal-content">
										<form method="POST" action="{{route('manage-projects.delete-permanent', $project->id)}}">
