...
@section('title') Trash Testimonials @endsection
			...
			<table class="table table-striped table-bordered">
				<thead>
					<tr>
						...
						<th><b>Name</b></th>
						<th width="20%"><b>Asal Kota</b></th>
						<th width="8%"><b>Status</b></th>
						<th width="16%"><b>Actions</b></th>
					</tr>
				</thead>
				<body>
					...
					<tr>
						...
						<td>
							<form
								method="POST"
								action="{{route('manage-testimonials.restore', $testimoni->id)}}"
								class="d-inline">
							...
							<div 
								...
								<div 
								    ...
								    <div class="modal-content">
									   	...
									   	<form method="POST" action="{{route('manage-testimonials.delete-permanent', $testimoni->id)}}">
									   		@csrf
									      	...
									      	<div class="modal-body">
											    Gambar slider dihapus permanen?
										    </div>
