...
@section('title') Trash Services @endsection
					...
					@forelse($services as $service)
						<tr>
							...
							<td>
								<form
									method="POST"
									action="{{route('manage-services.restore', $service->id)}}"
									class="d-inline">
							...
							<div 
								...
								<div 
								    ...
								    <div class="modal-content">
								   	...
								   	<form method="POST" action="{{route('manage-services.delete-permanent', $service->id)}}">
								   		@csrf
